...
* hmanage: an utility to toggle the overide-redirect property of any window; \
* and hhp, a simple utility to hide the pointer, similar ton unclutter. \
