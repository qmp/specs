...
Source0:   http://download.gnome.org/sources/gnome-packagekit/2.91/%{name}-%{version}.rnd.tar.gz
...
%changelog
* Sat May 21 2011 qmp <glang@lavabit.com> - 3.0.0-1.rnd
- Revert suppression of gpk-update-icon
